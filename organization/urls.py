...
urlpatterns = [
    ...
    url(r'^removeuserfromorg/(?P<pk>[0-9]+)/$', views.UsertoOrgDetail.as_view(),), #remove a user from an organizations
    ...
    url(r'^removeuserfromgroup/(?P<org>[0-9]+)/$', views.UsertoGroupsDetail.as_view(),), #get or delete a particular group belonging to a User in a particular organization
